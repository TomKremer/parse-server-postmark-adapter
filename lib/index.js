...
const PostmarkAdapter = (postmarkOptions) => {
  if (
    ...
    throw new Error(
      "PostmarkAdapter requires an API Key and a From Email Address."
    );
  }

  postmarkOptions.replyTo =
    postmarkOptions.replyTo || postmarkOptions.fromAddress;
  postmarkOptions.displayName =
    postmarkOptions.displayName || postmarkOptions.replyTo;
